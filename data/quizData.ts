...
export const quizPassages: QuizPassage[] = [
  {
    ...
    relatedExams: [
      ...
      },
      {
        ...
        isTrue: false,
        explanation:
          "이 장면에서 서술자는 인물의 행동과 외적 상황을 서술할 뿐, 내면 심리를 직접 서술하지 않습니다. '목숨을 끊으려 하챰늘'은 행동 묘사이지 내면 서술이 아닙니다.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "mp-sr-q1",
        statement:
          "(가)는 자연물인 '하늘'과 '들'을 청자로 설정하여 말을 건네는 방식을 취하고 있다.",
        isTrue: true,
        explanation:
      ...
      },
      {
        id: "mp-sr-q2",
        statement:
          "(가)의 마지막 연 '봄조차 빼앗기겠네'는 국권 회복에 대한 화자의 강한 확신을 보여준다.",
        isTrue: false,
        explanation:
      ...
      },
      {
        id: "mp-sr-q3",
        statement:
          "(가)의 '푸른 웃음 푸른 설움'은 감각의 전이(공감각적 심상)를 통해 화자의 복합적인 정서를 표현한 것이다.",
        isTrue: true,
        explanation:
      ...
      },
      {
        id: "mp-sr-q4",
        statement:
          "(나)는 6·25 전쟁 직후의 폐허를 배경으로 하여, 아이들을 통해 죽음의 공포를 부각하고 있다.",
        isTrue: false,
        explanation:
      ...
      },
      {
        id: "mp-sr-q5",
        statement:
          "(나)에서 '그림자'가 '울상'에서 '웃음'으로 변하는 것은 화자의 태도가 절망에서 긍정으로 전환되었음을 의미한다.",
        isTrue: true,
        explanation:
      ...
      },
      {
        id: "mp-sr-q6",
        statement:
          "(가)는 봄의 생동감을, (나)는 겨울의 황량함을 중심으로 시상을 전개하고 있다.",
        isTrue: false,
        explanation:
      ...
      },
      {
        id: "mp-sr-q7",
        statement:
          "두 작품 모두 화자 자신의 분신이나 내면을 투영하는 대상('혼', '그림자')이 등장한다.",
        isTrue: true,
        explanation:
      ...
      },
      {
        id: "mp-sr-q8",
        statement:
          "(가)의 '한 자욱도 섰지 마라'는 독립을 위해 멈추지 말고 투쟁하라는 행동 강령을 의미한다.",
        isTrue: false,
        explanation:
